...
PUBLIC_SSH_KEY=""
NEW_SSH_PORT=22
SITE_DOMAIN="contora13.oops.wtf"
SITE_REPO_URL="https://github.com/ilya034/Contora13Site"

while getopts :u:k:p flag
do
    case "${flag}" in
        n) NEW_USER_NAME=${OPTARG};;
        k) PUBLIC_SSH_KEY=${OPTARG};;
        p) NEW_SSH_PORT=${OPTARG};;
        s) SITE_REPO_URL=${OPTARG};;
...
git clone ${SITE_REPO_URL} /var/www/${SITE_DOMAIN}
